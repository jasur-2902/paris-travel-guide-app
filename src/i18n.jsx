...
const translations = {
  en: {
    ...
    // Tutorial
    'tutorial.tabs.title': 'Navigate Your Trip',
    'tutorial.tabs.desc': 'Switch between Table, Itinerary, and Map views to explore and plan your Paris activities.',
    'tutorial.addActivity.title': 'Add Custom Activities',
    'tutorial.addActivity.desc': 'Add your own restaurants, shops, or hidden gems to the trip planner.',
    'tutorial.viewToggle.title': 'Simple & Full Views',
    'tutorial.viewToggle.desc': 'Toggle between a streamlined Simple view and a detailed Full view with extra columns and features.',
    'tutorial.weather.title': 'Weather Forecast',
    'tutorial.weather.desc': 'Check the weather forecast for Paris. Click a day to jump to that date in your itinerary.',
    'tutorial.darkMode.title': 'Dark Mode',
    'tutorial.darkMode.desc': 'Switch between light and dark themes. Your preference is saved automatically.',
    'tutorial.settings.title': 'Settings & More',
    'tutorial.settings.desc': 'Change language, export your plan as CSV, copy your itinerary, and manage hidden activities.',
    'tutorial.budget.title': 'Budget Tracker',
    'tutorial.budget.desc': 'Track your spending against a budget. Click to expand for detailed cost breakdowns.',
    'tutorial.skip': 'Skip',
    'tutorial.prev': 'Back',
    'tutorial.next': 'Next',
    'tutorial.finish': 'Finish',
    'settings.startTour': 'Start tour',
  },
  es: {
    ...
    // Tutorial
    'tutorial.tabs.title': 'Navega tu viaje',
    'tutorial.tabs.desc': 'Cambia entre las vistas de Tabla, Itinerario y Mapa para explorar y planificar tus actividades en París.',
    'tutorial.addActivity.title': 'Agregar actividades',
    'tutorial.addActivity.desc': 'Agrega tus propios restaurantes, tiendas o lugares secretos al planificador.',
    'tutorial.viewToggle.title': 'Vista Simple y Completa',
    'tutorial.viewToggle.desc': 'Alterna entre una vista Simple y una vista Completa con columnas y funciones adicionales.',
    'tutorial.weather.title': 'Pronóstico del clima',
    'tutorial.weather.desc': 'Consulta el pronóstico del clima para París. Toca un día para ir a esa fecha en tu itinerario.',
    'tutorial.darkMode.title': 'Modo oscuro',
    'tutorial.darkMode.desc': 'Cambia entre temas claro y oscuro. Tu preferencia se guarda automáticamente.',
    'tutorial.settings.title': 'Ajustes y más',
    'tutorial.settings.desc': 'Cambia el idioma, exporta tu plan como CSV, copia tu itinerario y gestiona actividades ocultas.',
    'tutorial.budget.title': 'Control de presupuesto',
    'tutorial.budget.desc': 'Controla tus gastos respecto a un presupuesto. Haz clic para expandir y ver detalles de costos.',
    'tutorial.skip': 'Saltar',
    'tutorial.prev': 'Atrás',
    'tutorial.next': 'Siguiente',
    'tutorial.finish': 'Finalizar',
    'settings.startTour': 'Iniciar recorrido',
  },
  fr: {
    ...
    // Tutorial
    'tutorial.tabs.title': 'Naviguez votre voyage',
    'tutorial.tabs.desc': 'Basculez entre les vues Tableau, Itinéraire et Carte pour explorer et planifier vos activités à Paris.',
    'tutorial.addActivity.title': 'Ajouter des activités',
    'tutorial.addActivity.desc': 'Ajoutez vos propres restaurants, boutiques ou trésors cachés au planificateur.',
    'tutorial.viewToggle.title': 'Vues Simple et Complète',
    'tutorial.viewToggle.desc': 'Basculez entre une vue Simple épurée et une vue Complète avec colonnes et fonctionnalités supplémentaires.',
    'tutorial.weather.title': 'Prévisions météo',
    'tutorial.weather.desc': 'Consultez les prévisions météo pour Paris. Cliquez sur un jour pour accéder à cette date dans votre itinéraire.',
    'tutorial.darkMode.title': 'Mode sombre',
    'tutorial.darkMode.desc': 'Basculez entre les thèmes clair et sombre. Votre préférence est sauvegardée automatiquement.',
    'tutorial.settings.title': 'Paramètres et plus',
    'tutorial.settings.desc': 'Changez la langue, exportez votre plan en CSV, copiez votre itinéraire et gérez les activités masquées.',
    'tutorial.budget.title': 'Suivi du budget',
    'tutorial.budget.desc': 'Suivez vos dépenses par rapport à un budget. Cliquez pour développer et voir les détails des coûts.',
    'tutorial.skip': 'Passer',
    'tutorial.prev': 'Retour',
    'tutorial.next': 'Suivant',
    'tutorial.finish': 'Terminer',
    'settings.startTour': 'Lancer la visite',
  },
};
